...
;;; 
;;; $Header: /cvsroot/acdk/acdk/acdk_sql_odbc/acdk_sql_odbc.lsp,v 1.16 2005/04/15 14:50:47 kommer Exp $
;;;
...
(defun make-project-main ()
  ...
  (setg acdk-projects
    '(
        ("src" "acdk_sql_odbc" () ("lib"))
        ("src" "acdk_tools_odbctests" ("acdk_sql_odbc") ("bin" "otest"))
        ("tests/acdk/sql" "acdk_sql_Test" ( ) ("bin" "utest"))
    )
  )
  (setg acdk-tests 
    '(
