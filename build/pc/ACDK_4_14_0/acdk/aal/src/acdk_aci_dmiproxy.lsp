...
;;; 
;;; $Header: /cvsroot/acdk/acdk/aal/src/acdk_aci_dmiproxy.lsp,v 1.2 2005/02/07 17:11:22 kommer Exp $
;;;
...
(defun make-main ()
  (acdk-main-init)
  (setg acdkmake-project-name "acdk_aci_dmiproxy")
  ...
  (setg acdkmake-project-sourcelist
    '(
      "acdk/aci/ast/ast_dmiproxy"
      "acdk/aci/parser/parser_dmiproxy"
    )
  )
