...
;;; 
;;; $Header: /cvsroot/acdk/acdk/aal/src/acdk_aal.lsp,v 1.5 2005/02/07 17:11:22 kommer Exp $
;;;
...
(defun make-main ()
  ...
  (setg acdkmake-project-name  "acdk_aal") ;;; replace this name
  ...
  (setg acdkmake-project-sourcelist ; directory and/or source files
    '(
      ...
      ; currently not work: "acdk/aal"
      ; currently not work: "acdk/aal/aal_metainf"
     )
  )
