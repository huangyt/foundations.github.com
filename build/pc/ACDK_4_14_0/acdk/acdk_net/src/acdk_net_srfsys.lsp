...
;;; 
;;; $Header: /cvsroot/acdk/acdk/acdk_net/src/acdk_net_srfsys.lsp,v 1.8 2005/02/07 17:15:25 kommer Exp $
;;;
...
(defun make-main ()
  ...
  (setg acdkmake-project-name "acdk_net_srfsys")
  ...
  (setg acdkmake-project-defines 
    '(
      ("IN_ACDK_NET_SRFSYS_LIB")
    )
  )
  (setg acdkmake-project-sourcelist 
    '(
      "acdk/net/srfsys"
      "acdk/net/srfsys/srfsys_metainf"
     )
  )
