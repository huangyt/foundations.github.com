...
(defun make-main ()
  ...
  (setg acdkmake-project-name "acdk_net_Test")
  ...
  (setg acdkmake-project-sourcelist
    '(
      "acdk_net_Test.cpp"
      "acdk_net_InetAddress_Test.cpp"
      "acdk_net_SendReceive.cpp"
      "acdk_net_URL_Test.cpp"
      "acdk_net_TransReaderWriter_Test.cpp"
      "acdk_net_DatagramSocket_Test.cpp"
      "acdk_net_TcpTimeout_Test.cpp"
