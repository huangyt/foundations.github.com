...
// 
// $Header: /cvsroot/acdk/acdk/acdk_wx/tests/acdk/wx/HelloWorld/HelloWorld.cpp,v 1.8 2005/03/08 18:56:26 kommer Exp $
...
public:
    ...
    : Dialog(parent, -1, "About")
  {
    ...
    //
    _okButton = new Button(this, wxID_OK, "OK");
...
public:
  ...
  : Frame(str) 
  {
    ...
    getWx()->SetTitle(wxString(_T("Test")));
  }
...
public:
  ...
  bool onInit()
  {
    ...
    win->connect(MoveEvent::EvtMove, -1, (ObjectEventFunction)&MyFrame::onMove);
    win->connect(SizeEvent::EvtSize, -1, (ObjectEventFunction)&MyFrame::onMove);
