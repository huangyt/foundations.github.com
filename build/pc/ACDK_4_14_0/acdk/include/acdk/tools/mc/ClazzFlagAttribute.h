...
#ifndef acdk_tools_mc_ClazzFlagAttribute_h
#define acdk_tools_mc_ClazzFlagAttribute_h
...
ACDK_DECL_CLASS(ClazzFlagAttribute);

/**
  Set the DMI-Flags with given flags.
  The flags will be or'ed with flags already
  set by declared attribute (public, static, etc)
*/
class ACDK_TOOLS_MC_PUBLIC ClazzFlagAttribute
: extends CodeAttribute
{
  ACDK_WITH_METAINFO(ClazzFlagAttribute)
public:
  int _clazzFlags;
  ClazzFlagAttribute(int flags = 0);
...
#endif //acdk_tools_mc_ClazzFlagAttribute_h
