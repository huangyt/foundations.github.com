...
#ifndef acdk_tools_mc_StringTagAttribute_h
#define acdk_tools_mc_StringTagAttribute_h
...
ACDK_DECL_CLASS(StringTagAttribute);

/**
  The StringTagAttribute attages a string 
  accessible via a string key to the metainof
  (module, class, method, argument, field)
*/
class ACDK_TOOLS_MC_PUBLIC StringTagAttribute
: extends CodeAttribute
{
  ACDK_WITH_METAINFO(StringTagAttribute)
public:
  RString key;
  RString value;
...
#endif //acdk_tools_mc_StringTagAttribute_h
