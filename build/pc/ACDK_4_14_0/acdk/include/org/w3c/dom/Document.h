...
// 
// $Header: /cvsroot/acdk/acdk/acdk_xml/src/org/w3c/dom/Document.h,v 1.13 2005/02/05 10:45:37 kommer Exp $
...
*/
ACDK_INTERFACE class ACDK_ORG_XML_PUBLIC Document
: implements Branch
{
  ACDK_WITH_METAINFO(Document)
public: 
  /**
  ...
  /**
     ...
     */
  virtual RElement createElement(IN(RString) s) THROWS1(RDOMException) = 0;
  /**
  ...
  /**
     ...
     */
  virtual RCDATASection createCDATASection(IN(RString) s) THROWS1(RDOMException) = 0;
  /**
     ...
     */
  virtual RProcessingInstruction createProcessingInstruction(IN(RString) s, IN(RString) s1) THROWS1(RDOMException) = 0;
  /**
     ...
     *   <code>Document.xmlVersion</code> attribute.
     */
  virtual RAttr createAttribute(IN(RString) s) THROWS1(RDOMException) = 0;
  /**
     ...
     *   <br>NOT_SUPPORTED_ERR: Raised if this document is an HTML document.
     */
  virtual REntityReference createEntityReference(IN(RString) s) THROWS1(RDOMException) = 0;
  /**
  ...
  /*
     ...
     * @since DOM Level 2
     */
    // ### TODO implement me: public Node importNode(Node importedNode,  boolean deep) throws DOMException;
     ...
     * @since DOM Level 2
     */
    // ### TODO implement me: public Element createElementNS(String namespaceURI, String qualifiedName) throws DOMException;
     ...
     * @since DOM Level 2
     */
    // ### TODO implement me: public Attr createAttributeNS(String namespaceURI,  String qualifiedName) throws DOMException;
     ...
     * @since DOM Level 2
     */
    // ### TODO implement me: public NodeList getElementsByTagNameNS(String namespaceURI,  String localName);
     ...
     * @since DOM Level 2
     */
    // ### TODO implement me: public Element getElementById(String elementId);
     ...
     * @since DOM Level 3
     */
    // ### TODO implement me: public boolean getXmlStandalone();
    /*
     * An attribute specifying, as part of the <a href='http://www.w3.org/TR/2004/REC-xml-20040204#NT-XMLDecl'>XML declaration</a>, whether this document is standalone. This is <code>false</code> when 
     * unspecified.
     * <p ><b>Note:</b>  No verification is done on the value when setting 
     ...
     * @since DOM Level 3
     */
    // ### TODO implement me: public void setXmlStandalone(boolean xmlStandalone) throws DOMException;
     ...
     * @since DOM Level 3
     */
    // ### TODO implement me: public void setXmlVersion(String xmlVersion) throws DOMException;
     ...
     * @since DOM Level 3
     */
    // ### TODO implement me: public boolean getStrictErrorChecking();
    /*
     * An attribute specifying whether error checking is enforced or not. When 
     * set to <code>false</code>, the implementation is free to not test 
     * every possible error case normally defined on DOM operations, and not 
     ...
     * @since DOM Level 3
     */
    // ### TODO implement me: public void setStrictErrorChecking(boolean strictErrorChecking);
     ...
     * @since DOM Level 3
     */
    // ### TODO implement me: public String getDocumentURI();
    /*
     *  The location of the document or <code>null</code> if undefined or if 
     * the <code>Document</code> was created using 
     * <code>DOMImplementation.createDocument</code>. No lexical checking is 
     ...
     * @since DOM Level 3
     */
    // ### TODO implement me: public void setDocumentURI(String documentURI);
     ...
     * @since DOM Level 3
     */
    // ### TODO implement me: public Node adoptNode(Node source) throws DOMException;
     ...
     * @since DOM Level 3
     */
    // ### TODO implement me: public DOMConfiguration getDomConfig();
     ...
     * @since DOM Level 3
     */
    // ### TODO implement me: public void normalizeDocument();
     ...
     * @since DOM Level 3
     */
    // ### TODO implement me: public Node renameNode(Node n,  String namespaceURI,  String qualifiedName) throws DOMException;
};
