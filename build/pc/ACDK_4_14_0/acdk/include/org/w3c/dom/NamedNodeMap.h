...
// 
// $Header: /cvsroot/acdk/acdk/acdk_xml/src/org/w3c/dom/NamedNodeMap.h,v 1.13 2005/02/05 10:45:37 kommer Exp $
...
ACDK_DECL_INTERFACE(NamedNodeMap);
...
*/
class ACDK_ORG_XML_PUBLIC NamedNodeMap
      ACDK_INTERFACEBASE
{
  ACDK_WITH_METAINFO(NamedNodeMap)
public: 
  /**
  ...
  /**
     ...
     *   Entities.
     */
  virtual RNode setNamedItem(IN(RNode) arg) THROWS1(RDOMException) = 0;
  ...
  /**
     ...
     *   <br>NO_MODIFICATION_ALLOWED_ERR: Raised if this map is readonly.
     */
  virtual RNode removeNamedItem(IN(acdk::lang::RString) name) THROWS1(RDOMException) = 0;
  ...
  /**
     ...
     * @since DOM Level 2
     */
  // ### TODO implement me: public Node getNamedItemNS(String namespaceURI,  String localName) throws DOMException;
     ...
     * @since DOM Level 2
     */
    // ### TODO implement me: public Node setNamedItemNS(Node arg) throws DOMException;
     ...
     * @since DOM Level 2
     */
    // ### TODO implement me: public Node removeNamedItemNS(String namespaceURI,  String localName) throws DOMException;
};
