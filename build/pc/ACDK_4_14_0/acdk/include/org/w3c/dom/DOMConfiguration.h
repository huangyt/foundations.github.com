...
// 
// $Header: /cvsroot/acdk/acdk/acdk_xml/src/org/w3c/dom/DOMConfiguration.h,v 1.3 2005/02/05 10:45:37 kommer Exp $
/*
...
#ifndef org_w3c_dom_DOMConfiguration_h
#define org_w3c_dom_DOMConfiguration_h
...
ACDK_DECL_INTERFACE(DOMConfiguration);
...
/**
  ...
  @since DOM Level 3
 */
class ACDK_ORG_XML_PUBLIC DOMConfiguration
      ACDK_INTERFACEBASE
{
  ACDK_WITH_METAINFO(DOMConfiguration)
public: 
  /**
     ...
     */
  virtual void setParameter(IN(RString) name, IN(RObject) value) THROWS1(RDOMException) = 0;
    ...
    /**
     ...
     @exception DOMException
        NOT_FOUND_ERR: Raised when the parameter name is not recognized. 
     */
  virtual RObject getParameter(IN(RString) name) THROWS1(RDOMException) = 0;
     ...
     */
  virtual bool canSetParameter(IN(RString) name, IN(RObject) value) = 0;
  ...
  /**
     ...
     */
  virtual RStringArray getParameterNames() = 0;
...
#endif //org_w3c_dom_DOMConfiguration_h
