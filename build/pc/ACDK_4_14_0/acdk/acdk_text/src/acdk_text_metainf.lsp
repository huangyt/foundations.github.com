...
;;; 
;;; $Header: /cvsroot/acdk/acdk/acdk_text/src/acdk_text_metainf.lsp,v 1.3 2005/02/07 17:16:08 kommer Exp $
;;;
...
(defun make-main ()
  ...
  (setg acdkmake-project-name "acdk_text_metainf")
