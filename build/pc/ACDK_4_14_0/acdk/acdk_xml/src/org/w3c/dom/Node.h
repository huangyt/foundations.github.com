...
// 
// $Header: /cvsroot/acdk/acdk/acdk_xml/src/org/w3c/dom/Node.h,v 1.21 2005/02/13 03:25:57 kommer Exp $
...
ACDK_DEF_LIB_ENUM(ACDK_ORG_XML_PUBLIC, NodeType);
...
ACDK_DEF_LIB_ENUM(ACDK_ORG_XML_PUBLIC, DocumentPosition);
...
ACDK_DEF_LIB_ENUM(ACDK_ORG_XML_PUBLIC, NodeWriteFlags);
 ...
 * <p>See also the <a href='http://www.w3.org/TR/2004/REC-DOM-Level-3-Core-20040407'>Document Object Model (DOM) Level 3 Core Specification</a>.
  ...
  @date $Date: 2005/02/13 03:25:57 $
*/
class ACDK_ORG_XML_PUBLIC Node
      ACDK_INTERFACEBASE
{
  ACDK_WITH_METAINFO(Node)
public: 
  /**
  ...
  /**
     ...
     * @since DOM Level 2
     */
  virtual void setPrefix(IN(acdk::lang::RString) prefix) THROWS1(RDOMException) = 0;
     ...
     *   platform.
     */
  virtual acdk::lang::RString getNodeValue() THROWS1(RDOMException) = 0;
  /**
     * The value of this node, depending on its type; see the table above. 
     * When it is defined to be <code>null</code>, setting it has no effect, 
     * including if the node is read-only.
     ...
     */
  virtual void setNodeValue(IN(acdk::lang::RString) s) THROWS1(RDOMException) = 0;
  /**
  ...
  /**
     ...
     * @version DOM Level 3
     */
  virtual RNode insertBefore(IN(RNode) node, IN(RNode) node1) THROWS1(RDOMException) = 0;
  ...
  /**
     ...
     * @version DOM Level 3
     */
  virtual RNode replaceChild(IN(RNode) node, IN(RNode) node1) THROWS1(RDOMException) = 0;
  ...
  /**
     ...
     * @version DOM Level 3
     */
  virtual RNode removeChild(IN(RNode) node) THROWS1(RDOMException) = 0;
  ...
  /**
     ...
     * @version DOM Level 3
     */
  virtual RNode appendChild(IN(RNode) node) THROWS1(RDOMException) = 0;
  ...
  /**
     ...
     * @since DOM Level 3
     */
  virtual acdk::lang::RString getTextContent() THROWS1(org::w3c::dom::RDOMException)
  {
    acdk::lang::Object::_throwNotImplementedYet();
    return Nil;
  }
   ...
   /**
     ...
     * @since DOM Level 3
     */
  virtual void setTextContent(IN(acdk::lang::RString) textContent) THROWS1(org::w3c::dom::RDOMException)
  {
    acdk::lang::Object::_throwNotImplementedYet();
  }
  /**
    @see implementation in acdk::xml::dom::NodeUtil::selectNode
  */
  ...
  */
  ...
  /**
    select a string. XPath has to select a text node, comment or attribute
  */
  ...
  /**
    ...
    @todo implement in derived interfaces
  */
  virtual acdk::lang::RString toXML()  { return ""; }
  /**
    write this node
    @param out a byte writer
    @param writeFlags a combination of NodeWriteFlags
    @param indentLevel number of indention. Is not supported if written as HTML
  ...
  */
  ...
  /**
     ...
     * @version DOM Level 3
     */
    // ### TODO implement me: public void normalize();
  ...
  /**
     ...
     * @since DOM Level 2
     */
  // ### TODO implement me: public boolean isSupported(String feature,  String version);
  ...
  /**
     ...
     * @since DOM Level 2
     */
  // ### TODO implement me: public boolean hasAttributes();
  ...
  /**
     ...
     * @since DOM Level 3
     */
    // ### TODO implement me: public short compareDocumentPosition(Node other) throws DOMException;
  ...
  /**
     ...
     * @since DOM Level 3
     */
    // ### TODO implement me: public boolean isSameNode(Node other);
  ...
  /**
     ...
     * @since DOM Level 3
     */
    // ### TODO implement me: public String lookupPrefix(String namespaceURI);
     ...
     * @since DOM Level 3
     */
    // ### TODO implement me: public boolean isDefaultNamespace(String namespaceURI);
     ...
     * @since DOM Level 3
     */
    // ### TODO implement me: public String lookupNamespaceURI(String prefix);
  ...
  /**
     ...
     * @since DOM Level 3
     */
    // ### TODO implement me: public Object setUserData(String key,  Object data,  UserDataHandler handler);
     ...
     * @since DOM Level 3
     */
    // ### TODO implement me: public Object getUserData(String key);
