...
// 
// $Header: /cvsroot/acdk/acdk/acdk_xml/src/org/w3c/dom/DocumentType.h,v 1.13 2005/02/05 10:45:37 kommer Exp $
...
#ifndef org_w3c_dom_DocumentType_h
#define org_w3c_dom_DocumentType_h
...
*/
ACDK_INTERFACE class ACDK_ORG_XML_PUBLIC DocumentType
: implements Node
{
  ACDK_WITH_METAINFO(DocumentType)
public: 
  /**
  ...
  virtual RString getName() = 0;
   /**
     ...
     */
  virtual RNamedNodeMap getEntities() = 0;
  /**
     ...
     */
  virtual RNamedNodeMap getNotations() = 0;

  virtual RString toXML() 
  { 
    StringBuffer sb;
    toXML(sb);
    return sb.toString();
  }
  foreign void toXML(StringBuffer& sb);
  /**
  ...
  /*
     ...
     * @since DOM Level 2
     */
   // #### TODO implement me: public String getInternalSubset();
};
...
#endif //org_w3c_dom_DocumentType_h
