...
(defun make-main ()
  ...
  (setg acdkmake-project-name "acdk_xml_metainf")
  ...
  (setg acdkmake-project-sourcelist 
    '(
      "acdk/xml/xml_metainf"
      "acdk/xml/sax/sax_metainf"
      "acdk/xml/dom/dom_metainf"
      "acdk/xml/libxmldom/libxmldom_metainf"
      "acdk/xml/parsers/parsers_metainf"
     )
  )
