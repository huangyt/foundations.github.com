...
;;; 
;;; $Header: /cvsroot/acdk/acdk/acdk_make/src/acdk_make.lsp,v 1.4 2005/02/07 17:15:09 kommer Exp $
;;;
...
(defun make-main ()
  ...
  (setg acdkmake-project-name  "acdk_make") ;;; replace this name
