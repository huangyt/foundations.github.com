...
// 
// $Header: /cvsroot/acdk/acdk/acdk_sql_sqlite/tests/acdk/sql/sqlite/acdk_sql_sqlite_Select.cpp,v 1.2 2005/04/04 23:35:29 kommer Exp $
...
#include <acdk/sql/sqlite/LiteDriver.h>
...
RString getDbUrl()
{
  ...
  if (odbcUrl != Nil)
    return odbcUrl;
  ::acdk::sql::sqlite::RLiteDriver drv = new ::acdk::sql::sqlite::LiteDriver();
  odbcUrl = "jdbc:sqlite:/test.db";
  /*
