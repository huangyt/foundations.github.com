...
struct LikeOp {
  ...
  int nott;      /* True if the NOT keyword is present */
};
...
*/
void *sqlite3ParserAlloc(void *(*mallocProc)(int)){
  yyParser *pParser;
...
{ yygotominor.yy328 = atoi((const char*)yymsp[0].minor.yy430.z); }
...
{sqlite3AddCollateType(pParse, (const char*)yymsp[0].minor.yy430.z, yymsp[0].minor.yy430.n);}
...
{yygotominor.yy439 = (SrcList*)sqliteMalloc(sizeof(*yygotominor.yy439));}
...
{yygotominor.yy30.opcode = TK_LIKE; yygotominor.yy30.nott = 0;}

        break;
      case 208:

{yygotominor.yy30.opcode = TK_GLOB; yygotominor.yy30.nott = 0;}

        break;
      case 209:

{yygotominor.yy30.opcode = TK_LIKE; yygotominor.yy30.nott = 1;}

        break;
      case 210:

{yygotominor.yy30.opcode = TK_GLOB; yygotominor.yy30.nott = 1;}
...

{
  ...
  if( yymsp[-2].minor.yy30.nott ) yygotominor.yy418 = sqlite3Expr(TK_NOT, yygotominor.yy418, 0, 0);
...

{
  ...
  if( yymsp[-1].minor.yy430.n>0 ){
    ...
    if( p ) p->pColl = sqlite3LocateCollSeq(pParse, (const char*)yymsp[-1].minor.yy430.z, yymsp[-1].minor.yy430.n);
  }
