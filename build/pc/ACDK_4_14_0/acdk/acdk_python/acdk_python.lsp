...
;;; 
;;; $Header: /cvsroot/acdk/acdk/acdk_python/acdk_python.lsp,v 1.10 2004/06/17 18:16:52 kommer Exp $
;;;
...
(defun make-project-main ()
  ...
  (setg acdkmake-project-name "acdk_python")
  ...
  (setg acdk-projects
    '(
        ("src" "acdk_python" () ("lib"))
        ("src" "acdkpython" ("acdk_python") ("bin" "tool"))
        ("tests/acdk/python" "acdk_python_Test" ("acdk_python") ("bin" "utest"))
    )
  )
  (setg acdk-tests 
        '(
