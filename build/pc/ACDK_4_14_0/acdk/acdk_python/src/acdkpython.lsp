...
;;; 
;;; $Header: /cvsroot/acdk/acdk/acdk_python/src/acdkpython.lsp,v 1.4 2005/02/07 17:15:56 kommer Exp $
;;;
...
(defun make-main ()
  ...
  (setg acdkmake-project-name "acdkpython")
  ...
  (include "../python_cfg.lsp") ;; ajust confiburation here
