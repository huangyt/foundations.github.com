...
(defun make-main ()
  ...
  (setg acdkmake-project-name "acdk_tools_mc_Test")
  ...
  (setg acdkmake-project-sourcelist
    '(
		"acdk_tools_mc_Misc_Test.cpp"
		"acdk_tools_mc_Attributes_Test.cpp"
		"acdk_tools_mc_SetDispatchAttribute_Test.cpp"
		"acdk_tools_mc_Test.cpp"
