...
(defun make-main ()
  ...
  (setg acdkmake-project-name "acdk_lang_reflect_Test")
  ...
  (setg acdkmake-project-sourcelist
    '(
      "acdk_lang_reflect_Test.cpp"
      "acdk_lang_reflect_Method_Test.cpp"
      "acdk_lang_reflect_Constructor_Test.cpp"
      "acdk_lang_reflect_Field_Test.cpp"
      "acdk_lang_reflect_Unit_Test.cpp"
      "acdk_lang_reflect_Enumeration.cpp"
    )
  )
  (acdkmake-main)
)
