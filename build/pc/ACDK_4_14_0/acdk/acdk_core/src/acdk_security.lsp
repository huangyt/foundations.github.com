...
;;; 
;;; $Header: /cvsroot/acdk/acdk/acdk_core/src/acdk_security.lsp,v 1.8 2005/02/07 11:25:36 kommer Exp $
;;;
...
(defun make-main ()
  ...
  (setg acdkmake-project-name "acdk_security")
