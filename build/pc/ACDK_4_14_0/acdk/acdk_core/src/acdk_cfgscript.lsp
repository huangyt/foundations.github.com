...
;;; 
;;; $Header: /cvsroot/acdk/acdk/acdk_core/src/acdk_cfgscript.lsp,v 1.3 2005/02/07 11:24:04 kommer Exp $
;;;
...
(defun make-main ()
  ...
  (setg acdkmake-project-name "acdk_cfgscript")
  ...
  (setg acdkmake-project-defines 
    '(
      ("IN_ACDK_CFGSCRIPT_LIB")
    )
  )
  (setg acdkmake-project-sourcelist
    '(
      "acdk/cfgscript"
      "acdk/cfgscript/cfgscript_metainf"
    )
  )
