...
;;; 
;;; $Header: /cvsroot/acdk/acdk/acdk_core/src/acdk_security_metainf.lsp,v 1.3 2005/02/07 11:25:36 kommer Exp $
;;;
...
(defun make-main ()
  ...
  (setg acdkmake-project-name "acdk_security_metainf")
  ...
  (setg acdkmake-project-sourcelist
    '(
      "acdk/security/security_metainf"
    )
  )
