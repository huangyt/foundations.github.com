...
;;; 
;;; $Header: /cvsroot/acdk/acdk/acdk_core/src/acdk_tools_aunit_dmiproxy.lsp,v 1.2 2005/02/07 11:25:36 kommer Exp $
;;;
...
(defun make-main ()
  ...
  (setg acdkmake-project-name "acdk_tools_aunit_dmiproxy")
  ...
  (setg acdkmake-project-sourcelist
    '(
      "acdk/tools/aunit/aunit_dmiproxy"
    )
  )
  (acdkmake-main)
)
