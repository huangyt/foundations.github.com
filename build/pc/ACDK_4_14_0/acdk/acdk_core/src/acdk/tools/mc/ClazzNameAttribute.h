...
#ifndef acdk_tools_mc_ClazzNameAttribute_h
#define acdk_tools_mc_ClazzNameAttribute_h
...
ACDK_DECL_CLASS(ClazzNameAttribute);
/**
  This attribute can be used to set the 
  name of a MetaInfo to given name.
  It may be useable to export a given
  class, field, method, argument with 
  another name via DMI than implemented in 
  ACDK C++.
*/
class ACDK_TOOLS_MC_PUBLIC ClazzNameAttribute
: extends CodeAttribute
{
  ACDK_WITH_METAINFO(ClazzNameAttribute)
public:
  RString _name;
  ClazzNameAttribute(IN(RString) name = "");
...
#endif //acdk_tools_mc_ClazzNameAttribute_h
