...
// 
// $Header: /cvsroot/acdk/acdk/acdk_core/src/acdk/util/Collection.h,v 1.12 2005/04/09 19:26:56 kommer Exp $

#ifndef acdk_util_Collection_h
#define acdk_util_Collection_h
...
class ACDK_CORE_PUBLIC Collection
      ACDK_INTERFACEBASE
{
  ACDK_WITH_METAINFO(Collection)
public:
