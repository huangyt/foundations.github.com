...
// 
// $Header: /cvsroot/acdk/acdk/acdk_core/src/acdk/lang/sys/RC_Heap.h,v 1.8 2005/03/07 13:47:28 kommer Exp $

#ifndef acdk_lang_sys_RC_Heap_h
#define acdk_lang_sys_RC_Heap_h
...
class ACDK_CORE_PUBLIC RC_Heap 
: public HeapFrame 
{
protected:
  size_t _allocated;
  int _objectCount;
public:
  RC_Heap(RHeapFrame top = 0, int flags = HeapIsThread, const char* name = "") 
  : HeapFrame(top, flags | HeapHasRC, name),
    _allocated(0),
    _objectCount(0)
  {
  }
  ...
  virtual bool gc(bool recursiv = true) { return false; }
