...
;;; 
;;; $Header: /cvsroot/acdk/acdk/acdk_perl/acdk_perl.lsp,v 1.16 2004/06/17 18:16:52 kommer Exp $
;;;
...
(defun make-project-main ()
  ...
  (setg acdkmake-project-name "acdk_perl")
  ...
  (setg acdk-projects
    '(
        ("src" "acdk_perl" () ("lib"))
        ("src" "acdkperl" (acdk_perl) ("lib"))
        ("tests/acdk/perl" "acdk_perl_Test" ("acdk_perl") ("bin" "utest"))
    )
  )
  (setg acdk-tests 
    '(
