...
;;; 
;;; $Header: /cvsroot/acdk/acdk/acdkx_rdmi/src/RDMIServer.lsp,v 1.1 2005/04/19 11:31:11 kommer Exp $
;;;
...
(defun make-main ()
  ...
  (setg acdkmake-project-name "RDMIServer")
