...
;;; 
;;; $Header: /cvsroot/acdk/acdk/acdk_sql/src/acdk_sql_metainf.lsp,v 1.3 2005/02/07 17:15:59 kommer Exp $
;;;
...
(defun make-main ()
  ...
  (setg acdkmake-project-name "acdk_sql_metainf")
