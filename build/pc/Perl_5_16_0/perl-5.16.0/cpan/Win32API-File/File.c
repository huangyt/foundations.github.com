...
#line 264 "File.c"
	ST(0) = sv_newmortal();
	if(  ! null_arg(ST(0))  &&  ! SvREADONLY(ST(0))  )
...
XS_EXTERNAL(boot_Win32API__File)
{
    ...
    XS_VERSION_BOOTCHECK;
        ...
        newXS("Win32API::File::_fileLastError", XS_Win32API__File__fileLastError, file);
        newXS("Win32API::File::CloseHandle", XS_Win32API__File_CloseHandle, file);
        newXS("Win32API::File::CopyFileA", XS_Win32API__File_CopyFileA, file);
        newXS("Win32API::File::CopyFileW", XS_Win32API__File_CopyFileW, file);
        newXS("Win32API::File::CreateFileA", XS_Win32API__File_CreateFileA, file);
        newXS("Win32API::File::CreateFileW", XS_Win32API__File_CreateFileW, file);
        newXS("Win32API::File::DefineDosDeviceA", XS_Win32API__File_DefineDosDeviceA, file);
        newXS("Win32API::File::DefineDosDeviceW", XS_Win32API__File_DefineDosDeviceW, file);
        newXS("Win32API::File::DeleteFileA", XS_Win32API__File_DeleteFileA, file);
        newXS("Win32API::File::DeleteFileW", XS_Win32API__File_DeleteFileW, file);
        newXS("Win32API::File::DeviceIoControl", XS_Win32API__File_DeviceIoControl, file);
        newXS("Win32API::File::FdGetOsFHandle", XS_Win32API__File_FdGetOsFHandle, file);
        newXS("Win32API::File::GetDriveTypeA", XS_Win32API__File_GetDriveTypeA, file);
        newXS("Win32API::File::GetDriveTypeW", XS_Win32API__File_GetDriveTypeW, file);
        newXS("Win32API::File::GetFileAttributesA", XS_Win32API__File_GetFileAttributesA, file);
        newXS("Win32API::File::GetFileAttributesW", XS_Win32API__File_GetFileAttributesW, file);
        newXS("Win32API::File::GetFileType", XS_Win32API__File_GetFileType, file);
        newXS("Win32API::File::GetHandleInformation", XS_Win32API__File_GetHandleInformation, file);
        newXS("Win32API::File::GetLogicalDrives", XS_Win32API__File_GetLogicalDrives, file);
        newXS("Win32API::File::GetLogicalDriveStringsA", XS_Win32API__File_GetLogicalDriveStringsA, file);
        newXS("Win32API::File::GetLogicalDriveStringsW", XS_Win32API__File_GetLogicalDriveStringsW, file);
        newXS("Win32API::File::GetVolumeInformationA", XS_Win32API__File_GetVolumeInformationA, file);
        newXS("Win32API::File::GetVolumeInformationW", XS_Win32API__File_GetVolumeInformationW, file);
        newXS("Win32API::File::IsRecognizedPartition", XS_Win32API__File_IsRecognizedPartition, file);
        newXS("Win32API::File::IsContainerPartition", XS_Win32API__File_IsContainerPartition, file);
        newXS("Win32API::File::MoveFileA", XS_Win32API__File_MoveFileA, file);
        newXS("Win32API::File::MoveFileW", XS_Win32API__File_MoveFileW, file);
        newXS("Win32API::File::MoveFileExA", XS_Win32API__File_MoveFileExA, file);
        newXS("Win32API::File::MoveFileExW", XS_Win32API__File_MoveFileExW, file);
        newXS("Win32API::File::OsFHandleOpenFd", XS_Win32API__File_OsFHandleOpenFd, file);
        newXS("Win32API::File::QueryDosDeviceA", XS_Win32API__File_QueryDosDeviceA, file);
        newXS("Win32API::File::QueryDosDeviceW", XS_Win32API__File_QueryDosDeviceW, file);
        newXS("Win32API::File::ReadFile", XS_Win32API__File_ReadFile, file);
        newXS("Win32API::File::GetOverlappedResult", XS_Win32API__File_GetOverlappedResult, file);
        newXS("Win32API::File::GetFileSize", XS_Win32API__File_GetFileSize, file);
        newXS("Win32API::File::SetErrorMode", XS_Win32API__File_SetErrorMode, file);
        newXS("Win32API::File::SetFilePointer", XS_Win32API__File_SetFilePointer, file);
        newXS("Win32API::File::SetHandleInformation", XS_Win32API__File_SetHandleInformation, file);
        newXS("Win32API::File::WriteFile", XS_Win32API__File_WriteFile, file);
        newXS("Win32API::File::GetStdHandle", XS_Win32API__File_GetStdHandle, file);
        newXS("Win32API::File::SetStdHandle", XS_Win32API__File_SetStdHandle, file);
#if (PERL_REVISION == 5 && PERL_VERSION >= 9)
  if (PL_unitcheckav)
