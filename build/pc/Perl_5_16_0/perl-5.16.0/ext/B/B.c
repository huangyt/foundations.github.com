...
XS_EUPXS(XS_B__COP_stashflags); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_B__COP_stashflags)
{
    dVAR; dXSARGS;
    if (items != 1)
       croak_xs_usage(cv,  "o");
...
XS_EXTERNAL(boot_B)
{
...

    {
        ...
        XSANY.any_i32 = 0;
#if XSubPPtmpAAAI
        newXS("B::COP::stashflags", XS_B__COP_stashflags, file);
#endif
#endif
#if XSubPPtmpAAAJ
