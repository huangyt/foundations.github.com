...
void SaveReportEx(void)
{
	...
	g_pSymEngine->GetReportFileName(pszDefExt, szFileName, countof(szFileName));

	PathRemoveFileSpec(g_szReportFilePath);
	PathCombine(szFilePath, g_szReportFilePath, szFileName);

	CopyFile(g_szInternalReportFilePath, szFilePath, FALSE);
